...
?>
<div class="header header-fixed header-logo-center" style="height:70px">
                    ...
                    ?>
                            <div class="form-check icon-check">
                                ...
                                <label class="form-check-label w-100" for="radio<?= $x; ?>"><?= $goal['goal_name']; ?>
                                    <span class="float-right"><?= $goal['goal_value'];
                                                                $_SESSION['goal_value'] = $goal['goal_value']; ?>km/hr</span>
                                </label>
