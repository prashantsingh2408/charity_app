                    ...
                    <div class="col-9 pl-0">
                        ...
                        ?>
                            <p class="mt-1">Not enough steps to donate <span class="ml-1 float-right">
                                    ...
                                    <button href="donate_ngo.php" class="btn btn-s btn-center-l bg-highlight text-uppercase font-900 text-uppercase rounded-s shadow-xl d-inline" disabled>Donate
                                        Steps</button></span></p>
