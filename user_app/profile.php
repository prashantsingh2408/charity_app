    ...
    <div class="container container-fluid">
            ...
            <div class="row mb-0">
                ...
                <div class="w-50 text-center">
                    <div class="tab-controls tabs-round tab-animated tabs-medium tabs-rounded shadow-xl"
                        data-tab-items="4" data-tab-active="bg-highlight activated color-white">
                        <a href="#" data-tab-active="" data-tab="tab-1" class="bg-highlight activated color-white"
                            style="width: 33%;">DAY</a>
        ...
        <div class="tab-content" id="tab-1" style="display: block;">
            <div class="chart-container" style="width:100%; height:350px;">
                ...
                <canvas class="chart chartjs-render-monitor" id="vertical-chart"
                    style="display: block; height: 350px; width: 314px;" width="628" height="700"></canvas>
            </div>
        </div>
