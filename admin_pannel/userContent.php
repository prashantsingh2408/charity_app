                    ...
                    <tr>
                        ...
                        <th class="float-right">
                            <form id='userAddForm' method="get" action='userAdd.php'>
                                <button form='userAddForm' type="submit" name="id" value="<?= $id ?>"
                        ...
                        <td class='text-right py-0 align-middle'>
                            <div class='btn-group btn-group-sm'>
                                ...
                                <form method='get' action='userView.php'>
                                    <button type="submit" name="id" value="<?= $id ?>" class='btn btn-info'><i
                                            class='fas fa-eye'></i></button>
                                </form>
                                <a onclick='removeUser(<?= $id; ?>)' class='btn btn-danger'><i
