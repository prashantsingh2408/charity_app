...
//Create new id
  ...
  $id_new = create_id('advertisements');

//Insert link
  $link = $_POST['link'];
  $sql = "UPDATE advertisements SET link = '$link' WHERE id=$id_new";
  $conn-> query($sql);
...
//// Input file
  ...
  // save  img location in db
  $sql = "UPDATE advertisements SET img = '$target_file' WHERE id= $id_new";
  $conn->query($sql);
////END Input file
